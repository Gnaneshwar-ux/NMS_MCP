...
interface PolicyFileConfig extends PolicySectionInput {
  commandPolicy?: PolicySectionInput;
  sqlPolicy?: PolicySectionInput;
}

export const DEFAULT_BLOCKED_CATEGORIES: readonly string[] = [];

export const DEFAULT_APPROVAL_CATEGORIES = ["session-state"] as const;

export const DEFAULT_SQL_BLOCKED_CATEGORIES: readonly string[] = [];
...
export function summarizeCombinedPolicyConfig(
  ...
  return {
    ...
    commandPolicy: summarizePolicySection(commandPolicy),
